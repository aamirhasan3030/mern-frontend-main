  ...
  return (
    <div className="orders-container">
      ...
      <div className="orders-filter">
        <select className="orders-select" onChange={(e) => setStatus(e.target.value)}>
        ...
        orders.map((order) => (
          <li className="orders-item">
            ...
            {order.status === "Pending" && (
              <>
                <button className="orders-cancel-btn" onClick={() => updateOrder("cancelled", order._id)}>
                  Cancel
                </button>
                -
                <button className="orders-complete-btn" onClick={() => updateOrder("completed", order._id)}>
                  Complete
                </button>
              </>
            )}
      ...
      <div className="orders-pagination">
        <button className="orders-prev-btn" disabled={page === 1} onClick={() => setPage(page - 1)}>
          Previous
        </button>
